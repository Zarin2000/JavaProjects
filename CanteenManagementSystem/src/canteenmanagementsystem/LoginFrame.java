...
public class LoginFrame extends JFrame {
    public LoginFrame() {
        ...
        userLabel.setBounds(400, 20, 80, 25);
        userField.setBounds(500, 20, 150, 25);
        passLabel.setBounds(400, 60, 80, 25);
        passField.setBounds(500, 60, 150, 25);
        loginButton.setBounds(450, 150, 100, 30);
